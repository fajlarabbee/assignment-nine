	...
	$("#cform").validate({
		...
		submitHandler: function() {
			$.ajax({
				...
				type: 'post',
				dataType: 'json',
				data: 'name='+ $("#cform").find('input[name="name"]').val() + '&email='+ $("#cform").find('input[name="email"]').val() + '&message=' + $("#cform").find('textarea[name="message"]').val() + '&_token=' + $("#cform").find('input[name="_token"]').val(),
				beforeSend: function() {
